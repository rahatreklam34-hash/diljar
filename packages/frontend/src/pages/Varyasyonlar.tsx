  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-5">
        <div className="w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center"><Layers className="text-indigo-600" size={22} /></div>
      ...
      <form onSubmit={add} className="bg-white rounded-xl border border-slate-200 p-4 mb-6 grid sm:grid-cols-[180px_1fr_auto] gap-2 items-end">
        ...
        <button className="inline-flex items-center gap-1 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-indigo-700"><Plus size={16} /> Şablon Ekle</button>
      </form>
